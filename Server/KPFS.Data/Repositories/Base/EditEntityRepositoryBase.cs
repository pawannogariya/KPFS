...
{
    public abstract class EditEntityRepositoryBase<TEntity, TId> : EntityRepositoryBase<TEntity, TId> where TEntity : EditEntityBase<TId>
    {
        protected EditEntityRepositoryBase(KpfsDbContext context, IConfiguration configuration) : base(context, configuration)
        {
        }
